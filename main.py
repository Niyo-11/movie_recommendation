...
selected_features = ["genres","keywords", "tagline", "cast", "director"] # the cols we are going to use

for feature in selected_features:
  movies_data[feature] = movies_data[feature].fillna("") # cleaning the data removing the unwanted colums
